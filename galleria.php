...
which includes a table of photos to be added to the post type as children of the post
with a title for the gallery and caption for each image

*/

class Galleria_for_WordPress {
...
$Galleria_for_WordPress = new Galleria_for_WordPress;
